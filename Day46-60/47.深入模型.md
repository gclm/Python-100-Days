...
3. 运行项目，在浏览器中访问`http://127.0.0.1:8000/admin`，输入刚才创建的超级用户账号和密码进行登录。
   ...
   <!-- 原图 django-admin-apps.png 缺失，待补充 -->
...
4. 注册模型类。
   ...
   <!-- 原图 django-admin-models.png 缺失，待补充 -->
...
5. 对模型进行CRUD操作。
   ...
   - 添加学科。
       ...
       <!-- 原图 django-admin-add-model.png 缺失，待补充 -->

   - 查看所有学科。

       <!-- 原图 django-admin-view-models.png 缺失，待补充 -->

   - 删除和更新学科。

       <!-- 原图 django-admin-delete-update-model.png 缺失，待补充 -->
...
6. 注册模型管理类。
   ...
   <!-- 原图 django-admin-view-models-subject.png 缺失，待补充 -->
   
   <!-- 原图 django-admin-view-models-teacher.png 缺失，待补充 -->
